    ...
    <div className="relative">
      ...
      <section className="relative min-h-[85vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.88 0.28 142 / 0.06) 0%, transparent 70%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.72 0.28 330 / 0.05) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 max-w-4xl mx-auto">
          ...
          <div className="animate-float">
            <img
              ...
              style={{
                filter: "drop-shadow(0 0 20px oklch(0.88 0.28 142 / 0.6))",
              }}
            />
          </div>
          ...
          <div>
            <h1 className="font-arcade text-3xl sm:text-5xl lg:text-6xl leading-tight">
              <span className="neon-text-green animate-pulse-neon block">
                ARCADE
              </span>
          ...
          <p className="font-orbitron text-base sm:text-xl font-semibold text-foreground/70 max-w-2xl tracking-wide">
            YOUR ULTIMATE <span className="neon-text-yellow">GAMING</span>{" "}
            DESTINATION
          </p>

          <p className="font-rajdhani text-lg text-foreground/50 max-w-lg">
            Play your favorite browser games instantly. No downloads, no
            sign-ups — just pure gaming fun.
          </p>
          ...
          <div className="flex items-center gap-8 mt-4 pt-4 border-t border-border/30 w-full max-w-sm justify-center">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="font-arcade text-xl neon-text-green">
                  {stat.value}
                </div>
                <div className="font-orbitron text-xs text-foreground/40 mt-1">
                  {stat.label}
                </div>
              </div>
            ))}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="font-rajdhani text-lg text-foreground/60 mb-6 max-w-md mx-auto">
                Jump into any game instantly. All games run directly in your
