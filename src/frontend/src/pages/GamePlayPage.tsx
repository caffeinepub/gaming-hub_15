...
> = {
  ...
  "stellar-assault": lazy(
    () => import("../components/games/StellarAssaultGame"),
  ),
...
> = {
  "shadow-run": {
    title: "Shadow Run",
    description: "Endless runner through neon shadows",
    color: "#a855f7",
  },
  "prism-jump": {
    title: "Prism Jump",
    description: "Navigate a glowing ball through prismatic tunnels",
    color: "#22d3ee",
  },
  "cyber-strike": {
    title: "Cyber Strike",
    description: "Tactical cyber warfare shooter",
    color: "#f43f5e",
  },
  "pixel-voyage": {
    title: "Pixel Voyage",
    description: "Fly through pixel skies",
    color: "#4ade80",
  },
  "arena-blitz": {
    title: "Arena Blitz",
  ...
  "grid-wars": {
    title: "Grid Wars",
    description: "Strategic grid-based warfare",
    color: "#22d3ee",
  },
  "rune-quest": {
    title: "Rune Quest",
    description: "Ancient rune-powered magic combat",
    color: "#a855f7",
  },
  "voxel-realms": {
    title: "Voxel Realms",
    description: "Build and defend your voxel kingdom",
    color: "#4ade80",
  },
  "neon-kick": {
    title: "Neon Kick",
    description: "Neon-lit soccer action",
    color: "#facc15",
  },
  "stellar-assault": {
    title: "Stellar Assault",
    description: "Rhythm-based space shooter",
    color: "#f43f5e",
  },
  "neon-racers": {
    title: "Neon Racers",
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex items-center gap-4 px-4 py-3 border-b border-border bg-card/80 backdrop-blur-sm sticky top-0 z-50">
        ...
        <div className="flex-1 min-w-0">
          <h1
            className="font-arcade text-sm truncate"
            style={{ color: info.color, textShadow: `0 0 10px ${info.color}` }}
          >
            {info.title}
          </h1>
          <p className="text-muted-foreground text-xs font-rajdhani truncate">
            {info.description}
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-background p-2 overflow-auto">
        {GameComponent ? (
          <Suspense
            fallback={
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="font-arcade text-neon-green text-sm animate-pulse">
                  LOADING...
                </p>
              </div>
            }
          ...
          <div className="text-center">
            <p className="font-arcade text-destructive text-sm">
              GAME NOT FOUND
            </p>
