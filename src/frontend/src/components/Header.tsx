...
import { Gamepad2, Grid3X3, Home } from "lucide-react";
...
export default function Header() {
  ...
  return (
    <header
      className="sticky top-0 z-50 w-full border-b border-neon-green/20 bg-background/90 backdrop-blur-md"
      style={{
        boxShadow:
          "0 1px 0 oklch(0.88 0.28 142 / 0.2), 0 4px 20px oklch(0 0 0 / 0.5)",
      }}
    >
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="relative w-10 h-10 flex-shrink-0">
              <img
                ...
                style={{
                  filter: "drop-shadow(0 0 8px oklch(0.88 0.28 142 / 0.7))",
                }}
              />
            </div>
            <span
