...
const GAMES = [
  {
    ...
    title: "Shadow Run",
    description:
      "Sprint through neon-lit shadows, dodge obstacles, and collect power-ups in this endless runner.",
    genre: "Runner",
  ...
  },
  {
    ...
    title: "Prism Jump",
    description:
      "Navigate a glowing ball through prismatic tunnels at breakneck speed.",
    genre: "Arcade",
  ...
  },
  {
    ...
    title: "Cyber Strike",
    description:
      "Engage in tactical cyber warfare with precision shooting and strategic movement.",
    genre: "Shooter",
  ...
  },
  {
    ...
    title: "Pixel Voyage",
    description:
      "Pilot your pixel ship through treacherous skies, avoiding obstacles in this addictive flyer.",
    genre: "Arcade",
  ...
  },
  {
    ...
    title: "Arena Blitz",
    description:
      "Dominate the arena in fast-paced combat. Defeat waves of enemies to claim victory.",
    genre: "Action",
  ...
  },
  {
    ...
    title: "Grid Wars",
    description:
      "Command your units on a neon grid battlefield in this strategic warfare game.",
    genre: "Strategy",
  ...
  },
  {
    ...
    title: "Rune Quest",
    description:
      "Harness ancient rune magic to defeat enemies and solve mystical puzzles.",
    genre: "RPG",
  ...
  },
  {
    ...
    title: "Voxel Realms",
    description:
      "Build, explore, and defend your voxel kingdom against waves of invaders.",
    genre: "Builder",
  ...
  },
  {
    ...
    title: "Neon Kick",
    description:
      "Score goals in this electrifying neon soccer game with physics-based gameplay.",
    genre: "Sports",
  ...
  },
  {
    ...
    description:
      "Blast through asteroid fields and enemy fleets in this rhythm-based space shooter.",
    genre: "Shooter",
    thumbnailPath:
      "/assets/generated/game-cover-stellar-assault.dim_400x300.png",
    accentColor: "pink" as const,
  },
  {
    id: "neon-racers",
    title: "Neon Racers",
    description:
      "Race at hypersonic speeds through neon circuits in this adrenaline-fueled racer.",
    genre: "Racing",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-neon-green/30 bg-neon-green/5 mb-4">
            ...
            <span className="font-orbitron text-xs font-bold text-neon-green tracking-widest">
              GAME LIBRARY
            </span>
          </div>
          <h2 className="font-orbitron font-black text-3xl sm:text-4xl text-foreground">
            CHOOSE YOUR <span className="neon-text-pink">GAME</span>
          </h2>
