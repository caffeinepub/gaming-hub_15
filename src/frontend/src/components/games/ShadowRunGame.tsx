  ...
  return (
    <div className="flex flex-col items-center gap-4 select-none">
      <div className="relative">
        ...
        {gameState === "idle" && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/70 rounded-lg">
            ...
            <button
              type="button"
              onClick={startGame}
              className="font-arcade text-sm bg-purple-600 hover:bg-purple-500 text-white px-6 py-3 rounded border border-purple-400 transition-all"
        ...
        {gameState === "over" && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 rounded-lg">
            ...
            <p className="font-arcade text-purple-300 text-sm mb-1">
              SCORE: {displayScore}
            </p>
      ...
      <p className="font-rajdhani text-purple-400/60 text-sm">
        SPACE/↑ to jump • ↓ to duck • Click to play
      </p>
    </div>
  );
}
