...
export default function PrismJumpGame() {
  ...
  return (
    <div className="flex flex-col items-center gap-4 select-none">
      <div className="relative">
        ...
        {gameState === "idle" && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/75 rounded-lg">
            <h2
              className="font-arcade text-3xl text-cyan-400 mb-2"
              style={{ textShadow: "0 0 20px #22d3ee" }}
            >
              PRISM JUMP
            </h2>
            <p className="font-rajdhani text-cyan-300 text-lg mb-6">
              Navigate the neon tunnel
            </p>
            <button
              type="button"
              onClick={startGame}
            ...
            <p className="mt-4 font-rajdhani text-cyan-300/60 text-sm">
              SPACE / Click — Jump
            </p>
          </div>
        )}
        {gameState === "over" && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 rounded-lg">
            ...
            <p className="font-arcade text-cyan-300 text-sm mb-1">
              SCORE: {displayScore}
            </p>
            ...
            <p className="font-arcade text-white/50 text-xs mb-6">
              BEST: {Math.floor(stateRef.current.highScore)}
            </p>
            <button
              type="button"
              onClick={startGame}
      ...
      <p className="font-rajdhani text-cyan-400/60 text-sm">
        SPACE / Click to jump through the tunnel
      </p>
    </div>
  );
}
