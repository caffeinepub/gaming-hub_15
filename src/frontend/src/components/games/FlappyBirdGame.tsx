...
export default function FlappyBirdGame() {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-4 select-none">
      <div className="font-orbitron text-xs text-foreground/50">
        SPACE / CLICK to flap
      </div>
      <div className="relative">
        ...
        {gameOver && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/85 rounded gap-4">
            ...
            <div className="font-orbitron text-sm text-foreground/50">
              Best: <span className="neon-text-green">{highScore}</span>
            </div>
            <button
              type="button"
              onClick={startGame}
        ...
        {!started && !gameOver && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/70 rounded gap-4 pointer-events-none">
            ...
            <div className="font-orbitron text-xs text-foreground/60">
