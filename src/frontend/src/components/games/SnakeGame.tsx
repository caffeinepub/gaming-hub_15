...
export default function SnakeGame() {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-4 select-none">
      ...
      >
        ...
        {(!started || gameOver) && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 rounded gap-4">
            {gameOver && (
              <>
                <div className="font-arcade text-xl neon-text-pink">
                  GAME OVER
                </div>
            ...
            {!started && !gameOver && (
              <div className="font-arcade text-base neon-text-green text-center leading-8">
                SNAKE
              </div>
            )}
            <button
      ...
      <p className="font-rajdhani text-sm text-foreground/40">
        Eat the pink dots to grow. Avoid walls and yourself!
      </p>
    </div>
  );
}
