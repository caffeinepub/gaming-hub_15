      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="relative">
          ...
          {(!started || gameOver) && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/85 rounded gap-4">
              ...
              <div className="font-orbitron text-xs text-foreground/60 text-center">
        ...
        <div className="flex flex-col gap-4 min-w-[120px]">
          <div className="border border-neon-cyan/20 rounded p-3 bg-card/50">
            <div className="font-orbitron text-xs text-foreground/50 mb-1">
              NEXT
            </div>
            <canvas
              ref={nextCanvasRef}
          ...
          <div className="border border-neon-cyan/20 rounded p-3 bg-card/50">
            ...
            <div className="font-orbitron font-bold text-lg neon-text-cyan">
              {score}
            </div>
          </div>
          <div className="border border-neon-cyan/20 rounded p-3 bg-card/50">
            ...
            <div className="font-orbitron font-bold text-lg neon-text-green">
              {level}
            </div>
          </div>
          <div className="border border-neon-cyan/20 rounded p-3 bg-card/50">
            ...
            <div className="font-orbitron font-bold text-lg text-foreground/80">
              {lines}
            </div>
          </div>
        </div>
