        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <Gamepad2
              ...
              style={{
                filter: "drop-shadow(0 0 6px oklch(0.88 0.28 142 / 0.7))",
              }}
            />
            <span className="font-arcade text-xs neon-text-green">
              ARCADE HUB
            </span>
          </div>
          ...
          <p className="text-xs text-foreground/30 font-rajdhani flex items-center gap-1.5">
            ...
            <Heart
              size={12}
              className="text-neon-pink inline"
              style={{
                filter: "drop-shadow(0 0 4px oklch(0.72 0.28 330 / 0.8))",
              }}
            />{" "}
            using{" "}
            <a
